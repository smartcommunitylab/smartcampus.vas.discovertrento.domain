...
public class  UserPersonalEventFactoryInterface extends DomainTypeInterfaceImpl {

    private static DomainTypeInterface intf = null;
    public static DomainTypeInterface getInstance() {
        if (intf==null) intf = new UserPersonalEventFactoryInterface();
        return intf;
    }
    ...
    public String getName() {
        return "UserPersonalEventFactory";
    }
    ...
    static {
        ...
        o = new OperationImpl();
        o.setName("personalizeEvent");
        o.setReturn(new Type(java.lang.Boolean .class, false));
