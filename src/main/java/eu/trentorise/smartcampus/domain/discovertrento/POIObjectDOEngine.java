...
public class POIObjectDOEngine extends AbstractDOEngineImpl {

    public POIObjectDOEngine() {
        super();
    }
    ...
    public String getType() {
        return "eu.trentorise.smartcampus.domain.discovertrento.POIObject";
    }
    ...
    public it.sayservice.platform.domain.model.interfaces.DomainTypeInterface getInterface() throws it.sayservice.platform.core.domain.common.exception.DomainDataHandlerException {
        return eu.trentorise.smartcampus.domain.discovertrento .POIObjectInterface .getInstance();
    }
