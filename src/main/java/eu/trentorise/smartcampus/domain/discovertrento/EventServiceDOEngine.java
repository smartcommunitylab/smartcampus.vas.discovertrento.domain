...
public class EventServiceDOEngine extends AbstractDOEngineImpl {

    public EventServiceDOEngine() {
        super();
    }
    ...
    public String getType() {
        return "eu.trentorise.smartcampus.domain.discovertrento.EventService";
    }
    ...
    public it.sayservice.platform.domain.model.interfaces.DomainTypeInterface getInterface() throws it.sayservice.platform.core.domain.common.exception.DomainDataHandlerException {
        return eu.trentorise.smartcampus.domain.discovertrento .EventServiceInterface .getInstance();
    }
