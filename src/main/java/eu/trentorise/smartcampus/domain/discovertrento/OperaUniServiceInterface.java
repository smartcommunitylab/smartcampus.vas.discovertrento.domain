...
public class  OperaUniServiceInterface extends DomainTypeInterfaceImpl {

    private static DomainTypeInterface intf = null;
    public static DomainTypeInterface getInstance() {
        if (intf==null) intf = new OperaUniServiceInterface();
        return intf;
    }
    ...
    static {
        ...
        o = new OperationImpl();
        o.setName("subscribeOULocations");
