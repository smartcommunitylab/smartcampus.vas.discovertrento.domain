...
public class StoryFactoryDOEngine extends AbstractDOEngineImpl {

    public StoryFactoryDOEngine() {
        super();
    }
...
eu.trentorise.smartcampus.domain.discovertrento.GenericStory data = (eu.trentorise.smartcampus.domain.discovertrento.GenericStory) tuple.get("data");
...
getDomainObjectHandler().create(null, "eu.trentorise.smartcampus.domain.discovertrento.StoryObject", body, evts, ops, securityToken, bundleId);}
}
return null;
}
    ...
    public String getType() {
        return "eu.trentorise.smartcampus.domain.discovertrento.StoryFactory";
    }
    ...
    public it.sayservice.platform.domain.model.interfaces.DomainTypeInterface getInterface() throws it.sayservice.platform.core.domain.common.exception.DomainDataHandlerException {
        return eu.trentorise.smartcampus.domain.discovertrento .StoryFactoryInterface .getInstance();
    }
