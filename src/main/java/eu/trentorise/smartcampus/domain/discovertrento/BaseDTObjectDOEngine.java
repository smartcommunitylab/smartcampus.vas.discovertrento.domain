...
public class BaseDTObjectDOEngine extends AbstractDOEngineImpl {

    public BaseDTObjectDOEngine() {
        super();
    }
    ...
    public String getType() {
        return "eu.trentorise.smartcampus.domain.discovertrento.BaseDTObject";
    }
    ...
    public it.sayservice.platform.domain.model.interfaces.DomainTypeInterface getInterface() throws it.sayservice.platform.core.domain.common.exception.DomainDataHandlerException {
        return eu.trentorise.smartcampus.domain.discovertrento .BaseDTObjectInterface .getInstance();
    }
