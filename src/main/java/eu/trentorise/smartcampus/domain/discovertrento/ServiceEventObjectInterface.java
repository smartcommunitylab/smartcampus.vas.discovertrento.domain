...
public class  ServiceEventObjectInterface extends DomainTypeInterfaceImpl {

    private static DomainTypeInterface intf = null;
    public static DomainTypeInterface getInstance() {
        if (intf==null) intf = new ServiceEventObjectInterface();
        return intf;
    }
    ...
    static {
        ...
        vd.setType(new Type(eu.trentorise.smartcampus.domain.discovertrento.EventCustomData .class, false));
        varDefs.add(vd);
        vd = new VarDefImpl();
        vd.setVisibility(Visibility.PUBLIC);
        vd.setName("data");
    ...
    static {
        ...
        e = eu.trentorise.smartcampus.domain.discovertrento.EventObjectInterface .getInstance();
        extended.add(e);
    }    
    ...
    static {
        ...
        a.setType(new Type(eu.trentorise.smartcampus.domain.discovertrento.EventCustomData .class, false));
        o.addArgument(a);
        a = new ArgumentDefImpl();
        a.setName("newCommunityData");
        a.setType(new Type(eu.trentorise.smartcampus.domain.discovertrento.CommunityData .class, false));
