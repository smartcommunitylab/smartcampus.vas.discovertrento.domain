...
public class UserEventFactoryDOEngine extends AbstractDOEngineImpl {

    public UserEventFactoryDOEngine() {
        super();
    }
...
eu.trentorise.smartcampus.domain.discovertrento.GenericEvent data = (eu.trentorise.smartcampus.domain.discovertrento.GenericEvent) tuple.get("data");
...
getDomainObjectHandler().create(null, "eu.trentorise.smartcampus.domain.discovertrento.UserEventObject", body, evts, ops, securityToken, bundleId);}
}
return null;
}
    ...
    public String getType() {
        return "eu.trentorise.smartcampus.domain.discovertrento.UserEventFactory";
    }
    ...
    public it.sayservice.platform.domain.model.interfaces.DomainTypeInterface getInterface() throws it.sayservice.platform.core.domain.common.exception.DomainDataHandlerException {
        return eu.trentorise.smartcampus.domain.discovertrento .UserEventFactoryInterface .getInstance();
    }
