...
public class POIServiceDOEngine extends AbstractDOEngineImpl {

    public POIServiceDOEngine() {
        super();
    }
    ...
    public String getType() {
        return "eu.trentorise.smartcampus.domain.discovertrento.POIService";
    }
    ...
    public it.sayservice.platform.domain.model.interfaces.DomainTypeInterface getInterface() throws it.sayservice.platform.core.domain.common.exception.DomainDataHandlerException {
        return eu.trentorise.smartcampus.domain.discovertrento .POIServiceInterface .getInstance();
    }
